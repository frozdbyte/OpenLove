	...
	<main class="space-y-6 my-auto pt-2 pb-6">
		...
		<div class="grid grid-cols-3 gap-2">
			<div class="bg-card/70 dark:bg-card/50 border border-border/70 rounded-xl p-2.5 text-center shadow-2xs min-w-0 overflow-hidden flex flex-col justify-between">
				...
				<span class="{getStatValueSize(timeBreakdown.years)} font-bold font-serif text-foreground truncate tabular-nums block mt-1">{timeBreakdown.years}</span>
			</div>
			<div class="bg-card/70 dark:bg-card/50 border border-border/70 rounded-xl p-2.5 text-center shadow-2xs min-w-0 overflow-hidden flex flex-col justify-between">
				<span class="text-[10px] font-mono uppercase tracking-wider text-muted-foreground block truncate">Months</span>
				<span class="{getStatValueSize(timeBreakdown.totalMonths)} font-bold font-serif text-foreground truncate tabular-nums block mt-1">{timeBreakdown.totalMonths.toLocaleString()}</span>
			</div>
			<div class="bg-card/70 dark:bg-card/50 border border-border/70 rounded-xl p-2.5 text-center shadow-2xs min-w-0 overflow-hidden flex flex-col justify-between">
				<span class="text-[10px] font-mono uppercase tracking-wider text-muted-foreground block truncate">Weeks</span>
				<span class="{getStatValueSize(timeBreakdown.totalWeeks)} font-bold font-serif text-foreground truncate tabular-nums block mt-1">{timeBreakdown.totalWeeks.toLocaleString()}</span>
			</div>
			<div class="bg-card/70 dark:bg-card/50 border border-border/70 rounded-xl p-2.5 text-center shadow-2xs min-w-0 overflow-hidden flex flex-col justify-between">
				<span class="text-[10px] font-mono uppercase tracking-wider text-muted-foreground block truncate">Days</span>
				<span class="{getStatValueSize(timeBreakdown.totalDays)} font-bold font-serif text-foreground truncate tabular-nums block mt-1">{timeBreakdown.totalDays.toLocaleString()}</span>
			</div>
			<div class="bg-card/70 dark:bg-card/50 border border-border/70 rounded-xl p-2.5 text-center shadow-2xs min-w-0 overflow-hidden flex flex-col justify-between">
				<span class="text-[10px] font-mono uppercase tracking-wider text-muted-foreground block truncate">Hours</span>
				<span class="{getStatValueSize(timeBreakdown.totalHours)} font-bold font-serif text-foreground truncate tabular-nums block mt-1">{timeBreakdown.totalHours.toLocaleString()}</span>
			</div>
			<div class="bg-card/70 dark:bg-card/50 border border-border/70 rounded-xl p-2.5 text-center shadow-2xs min-w-0 overflow-hidden flex flex-col justify-between">
				<span class="text-[10px] font-mono uppercase tracking-wider text-muted-foreground block truncate">Minutes</span>
				<span class="{getStatValueSize(timeBreakdown.totalMinutes)} font-bold font-serif text-foreground truncate tabular-nums block mt-1">{timeBreakdown.totalMinutes.toLocaleString()}</span>
			</div>
		</div>

		<!-- Next Milestone Pinned Tag -->
		{#if nextMilestone}
